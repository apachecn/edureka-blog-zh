...
> 原文：<https://www.edureka.co/blog/statistics-and-probability/>
...
*![What Is Data - Statistics and Probability - Edureka](img/08008d47ff84271dc7d5af3bf7bb1158.png)*
...
![Categories Of Data - Statistics and Probability - Edureka](img/18028133a34e7ca94711a2de3cc79383.png)
...
*![Nominal Data - Statistics and Probability - Edureka](img/1bd96ad67b436fe7af9c85fa2ef98b90.png)*

*名义数据——统计与概率——爱德华卡*

*   *序数数据:*具有一系列有序信息的数据称为序数数据。

**![Ordinal Data - Statistics and Probability - Edureka](img/7a5c304d49e7201dd4c5616dbba37de2.png)**
...
*统计学是应用数学的一个领域，涉及数据的收集、分析、解释和呈现。*

![What Is Statistics - Statistics and Probability - Edureka](img/91a1c98c8b81522d04c7c42fb1e76ea6.png)
...
**![Population and Sample - Statistics and Probability - Edureka](img/cd71e9c27739a0c9c8e4a437958373a1.png)**
...
*抽样是一种统计方法，处理在总体中选择个体观察值的问题。它用于推断关于人口的统计知识。*
...
![Sampling Techniques - Statistics and Probability - Edureka](img/98c33d5e9207c7a29933962e5a1fdf9d.png)
...
**![Random Sampling - Statistics and Probability - Edureka](img/dfaa9de6791299cac09aa3e62c863ec4.png)**

*随机抽样——统计与概率——爱德华卡*

*   **系统抽样:**在系统抽样中，每第 n 条记录从总体中选出一部分作为样本。请参考下图，以便更好地理解系统采样的工作原理。

**![Systematic Sampling - Statistics and Probability - Edureka](img/ff18812330b6342260599ff30e7b26ff.png)**

*系统抽样——统计与概率——爱德华卡*

*   **分层抽样:**在分层抽样中，用一个阶层从一大群人中形成样本。阶层是人口中至少有一个共同特征的子集。此后，采用随机抽样的方法从每个阶层中选择足够数量的受试者。

![Stratified Sampling - Statistics and Probability - Edureka](img/ef68f1a9aa4166117f104e4e50aa57e3.png)
...
*描述性统计是一种通过对数据的样本和度量给出简短的总结来描述和理解特定数据集特征的方法。*

描述统计学主要关注数据的主要特征。它提供了数据的图形摘要。

![Descriptive Statistics - Statistics and Probability - Edureka](img/fddf7572769dc98ceefd90942ac64e7c.png)
...
![Inferential Statistics - Statistics and Probability - Edureka](img/e172fb9254e22482c92ba520d1ccba7a.png)
...
**![Measures Of Centre - Statistics and Probability - Edureka](img/9c40918d537c28b5abf0bd93e183359b.png)**
...
![DataSet - Statistics and Probability - Edureka](img/04199e01b31149359b78cf2c58999865.png)
...
![Measures Of Spread - Statistics and Probability - Edureka](img/87a51e4e8b455b0018849a420b93107c.png)
...
![Measures Of Spread example - Statistics and Probability - Edureka](img/3f1e3416bd8f1e468e24dcd790c5ff1e.png)
...
![Measures Of Spread Variance - Statistics and Probability - Edureka](img/0454b69705b83de303eff724d1e8b082.png)
...
![Measures Of Spread Population Variance - Statistics and Probability - Edureka](img/8e3ea3bb7272e3275bd0fe48a81b4466.png)

*测量扩散人口方差——统计与概率——爱德华卡*

*   样本方差是平均值的平方差的平均值。可以用下面的公式计算:

![Measures Of Spread Sample Variance - Statistics and Probability - Edureka](img/d0bbd2cea6e5b6829410a79e9bb05813.png)

*扩散样本方差的度量——统计与概率——爱德华卡*

*   标准差:是一组数据与其均值的离差的度量。可以用下面的公式计算:

![Measures Of Spread Standard Deviation - Statistics and Probability - Edureka](img/54dd0cfffcae5d4870d861720a4090a2.png)
...
*![Measures Of Spread Standard Deviation - Statistics and Probability - Edureka](img/96e69ad8a12a0cd6035f49240c3c82a9.png)*
...
![Histogram - Statistics And Probability - Edureka](img/5cfcbd98a70e723ad257e6064e2a1977.png)
...
![Entropy - Statistics and Probability - Edureka](img/e40388db0c6634e75905ff36355f136d.png)
...
*![Information Gain - Statistics and Probability - Edureka](img/d70756fcb3b91ca9e5b8e5312eb2042a.png)*
...
![Use Case Dataset - Statistics and Probability - Edureka](img/1cc3e2104ee3d5396fa6890f72daf63d.png)
...
![Use Case - Statistics and Probability - Edureka](img/cc54ad58def2eee25979e66fd5740ac8.png)
...
![Calculating Entropy - Statistics and Probability - Edureka](img/3ab9f3524519ae96867915752def18c2.png)
...
![Possible Decision Trees- Statistics and Probability - Edureka](img/3a75d028cbaebf1488e633207707f3e6.png)

*可能的决策树——统计与概率——爱德华卡*

我们的下一步是计算每个决策变量(天气、风力、湿度、温度)的信息增益。*需要记住的一点是，必须选择导致最高 IG 的变量，因为它将为我们提供最精确的输出和信息。*

**属性的信息增益【风大】**

![Decision Tree Windy - Statistics and Probability - Edureka](img/b899b9e574c33175a129afe424d63486.png)
...
**![Information Gain windy - Statistics and Probability - Edureka](img/4f2e126662691f1094620c77f3e5de22.png)**

*信息增益 windy——统计与概率——edu reka*

**【展望】属性的信息增益**

![Decision Tree Outlook - Statistics and Probability - Edureka](img/8c1f75aed33ceb5ada99dc4a131e9ec0.png)
...
**![Information Gain outlook - Statistics and Probability - Edureka](img/4ccc236bcc0e0d8ad1a7876d95c9f147.png)**

*信息增益展望——统计与概率——爱德华卡*

**【湿度】属性的信息增益**

![Decision Tree Humidity - Statistics and Probability - Edureka](img/6fe23843a4cb5eae2d08cc563f615101.png)
...
**![Information Gain humidity - Statistics and Probability - Edureka](img/767f1fbdfaa1d1017982697bfadfc7d2.png)**

*信息增益湿度——统计与概率——爱德华卡*

**【温度】属性的信息增益**

![Decision Tree Temperature - Statistics and Probability - Edureka](img/aa91283e5a8502c5eb785766b3f7794d.png)
...
![Information Gain temperature - Statistics and Probability - Edureka](img/fa891bc292bed9c199333b65fcb6dc82.png)

*信息增益温度——统计与概率——爱德华卡*

下图显示了每个属性的 IG。具有最高 IG 的变量用于在根节点拆分数据。“Outlook”变量具有最高的 IG，因此它被分配给根节点。

![Information Gain Summary - Statistics and Probability - Edureka](img/cc949804da69b11ed372090679d65f78.png)
...
![Confusion Matrix Formula - Statistics and Probability - Edureka](img/6834833b10f0c7b2b3022744bc477e81.png)
...
![Confusion Matrix - Statistics and Probability - Edureka](img/edaecaa36c2c32e6eb64b352e6446c45.png)
...
![Probability Density Function - Statistics and Probability - Edureka](img/f381925845f4bed847347096475f4eb3.png)
...
![Normal Distribution - Statistics and Probability - Edureka](img/dc95951a30270cc9a5cc08c0ccfd0dac.png)
...
![Standard Deviation Curve 1 - Statistics and Probability - Edureka](img/cd7e084d8e16fc9704b9c3638c8dbac1.png)

*标准差曲线——统计与概率——爱德华卡*

标准差小，曲线高且窄:

### **![Standard Deviation Curve 2 - Statistics and Probability - Edureka](img/bc167c088582971625723ec1fd13cfbb.png)**
...
![Central Limit Theorem - Statistics and Probability - Edureka](img/df078538771005916273ef3c8b78ecb0.png)
...
### **![Marginal Probability - Statistics and Probability - Edureka](img/65061e9589a05482fc720ff6fca5779c.png)**
...
*贝叶斯定理用于计算条件概率，条件概率就是基于可能与事件相关的条件的先验知识，事件发生的概率。*

数学上，贝叶斯定理表示为:

![Bayes Theorem - Statistics and Probability - Edureka](img/bfd2509be0f0ea3b1a2e69ff52587ca9.png)
...
![Bayes Theorem Example - Statistics and Probability - Edureka](img/e6774fa155514a711d51d995c2e84ef8.png)
...
*如前所述，统计推断是统计学的一个分支，它处理基于从所讨论的群体中获取的数据样本来形成关于群体的推断和预测。*

你现在应该问的问题是，如何对样本进行推断或预测？答案是通过点估计。

## **什么是点估计？**

*点估计是利用样本数据来测量一个单一的值，作为一个未知总体参数的近似值或最佳估计。*
...
![Interval Estimate - Statistics and Probability - Edureka](img/2c4d8962779346c75c93fffbb00a6f02.png)
...
![Margin Of Error - Statistics and Probability - Edureka](img/93323aee3f43b56bf53e644d2eda2541.png)
...
![Estimating Level Of Confidence - Statistics and Probability - Edureka](img/da6bde58a6561a8f472ce462a1d8e6fc.png)
...
![Estimating Level Of Confidence Example - Statistics and Probability - Edureka](img/3bc82df61bbff13b398d7af4eecf3f8d.png)
...
![Hypothesis Testing Example - Statistics and Probability - Edureka](img/3f4fc728bb96ca8be2b4347a472134a5.png)
...
![Data Set - Statistics And Probability - Edureka](img/7dcf21e66637ca91d0804f6924ba7323.png) *数据集——统计和概率——爱德华卡*
