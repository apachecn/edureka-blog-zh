...
> 原文：<https://www.edureka.co/blog/ruby-on-rails-tutorial/>
...
![Ruby on Rails- edureka](img/b1c07d61182410978cc2a0d3793e622b.png) Ruby on Rails，也称为 Rails，是用 Ruby 编程语言编写的服务器端 web 应用框架。它是一个模型-视图-控制器框架，为数据库和网页提供了一个结构。使用 Rails 开发应用程序的速度至少比典型的 [Java](https://www.edureka.co/blog/java-tutorial/) 框架快十倍。
...
![Ruby5-ruby-on-rails-tutorial](img/00d12aeb45d2bea2ad25f1b3d507a011.png)
...
**![simplicity - edureka](img/49e055723744a74ece55aa939cef43b0.png)**

简单性 Ruby 的语法非常简单，可读性很强。它使 Ruby 开发人员能够用更少的代码做更多的事情。可读性还使得 Ruby 几乎是自文档化的，并减轻了开发人员编写单独注释或帮助文本的负担。

**![faster development - edureka](img/44757f6ddfa293b35485d0222a898111.png)**
...
**![Easy code - edureka](img/6aa6c8a5fd21c7ccde6509d276b7737c.png)**

**简单的代码维护和更新**–Ruby 以其稳定性和可预测性而闻名。修改现有代码和向站点添加新功能是非常容易的。这对于长期项目和创业公司来说尤其有价值。

**![cost effective - edureka](img/d0261fe67441b92bda81910482a79e49.png)**
...
![Frameworks - Ruby on Rails - edureka](img/af1f1b039bb11b5b1c84ed9c87d5e980.png)
...
![Ruby on rails - edureka](img/4502c51d66aa8029f3da50fb371d0962.png)
...
**![Benefits - Ruby on Rails - edureka](img/d1cac8bad2276b7f5cffe0611b5871b9.png)**
...
![model view controller - edureka](img/753de5c4b607e00d814dbbcc6a90e90b.png)
...
**![Install Ruby- Ruby on rails - edureka](img/e97f0624804ce1d36de119172af62301.png)**
...
![demo - edureka](img/c38f0bb57ed5ce3edf23d1bf686d203b.png)
...
![Ruby on Rails - edureka](img/8d5e09f460583a8e51952a7b489201f5.png)现在我们将把 Rails 欢迎页面改为我们的主页，为此我们需要使用以下命令生成一个名为 pages 的新控制器:

```
rails g controller pages
```

![pages controller - ruby on rails - edureka](img/3be65d11d2279184dc78335aae786714.png)
...
![Home page - edureka](img/15fd8e80b51267a900f00caf03b90933.png)终于到了设计网页的时候了:
...
![Web app - Ruby on Rails - edureka](img/c7079758eeab99ee8d6f72c94f6a6fe6.png)
