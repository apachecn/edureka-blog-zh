...
### **35。“如果既没有帧 id 也没有帧名”，您应该考虑在整个脚本中使用哪种技术？**T3】
...
### **42。TestNG 是如何允许你陈述依赖关系的？用一个例子解释一下。**T3】
