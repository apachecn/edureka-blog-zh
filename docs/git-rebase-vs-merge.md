...
> 原文：<https://www.edureka.co/blog/git-rebase-vs-merge/>
...
![](img/01538f594422877d260f60334f949bcc.png) **图 1:所做的更改保存在提交中**
...
![](img/eb78dcbf68d0cddffaebd68e77c6fb33.png) **图 2:存储库中所做的更改将被保存为一个新的提交，具有一个新的提交 id**

### **什么是分支？**

分支是代码的不同独立版本的表示。让我们举个例子来理解这一点，假设你有一个网站目前正在运行。网站看起来像这样。

![Sample - Merging - Git Rebase vs Merge - Edureka](img/f38f0a5b3813035abe3a17a0b93a629c.png) **图 3:变更前的网站示例**
...
![Git Rebase vs Merge - Edureka](img/85757a34c67652dc6e516a2de436cba0.png)

**图 4:主分支和特征分支**

一旦您完成了更改，我们只需将“功能”分支的更改“合并”到“主分支”中。现在，在特性分支中所做的更改也将存在于主分支中。

![Git Rebase vs Merge - Edureka](img/3eaf4472dde11a9ed610cbbb11a78b97.png)

**图 5:特征分支与主分支的合并**

如果我们考虑合并后的网站示例，可以在下图中看到变化:

![Hello World - Merging - Git Rebase vs Merge - Edureka](img/053b4c85811785e801e614d2d0570098.png) **图 6:将变更合并到主分支后，变更显示在网站上。**
...
![Before Merging - Git Rebase vs Merge - Edureka](img/291caeca27d5a82ba3196d4df4f726f7.png) **图 7:合并前**
...
![Merging - Git Rebase vs Merge - Edureka](img/858a5fa580e38baff267cdeaae995ebb.png) **图 8:合并后的**
...
![Merging - Git Rebase vs Merge - Edureka](img/257a4a77433910c6501cb78202fb5657.png) **图 Git 合并前后。**
...
*   导致笨拙的日志/历史
*   不太人性化![Git Merge - Git Rebase vs Merge - Edureka](img/08b74a0595a1bd2208eed3b55e2b324d.png)
...
![Before-and-After](img/dce63162fa351984bd6274be65ac1554.png) **图 12:git 改基前后**
...
**![fig13](img/a7c756648b11f7f7eb9888693d28f481.png)**
...
**![fig14](img/bb0e7a85b3ee4a8c88336a7d1ab654b9.png)**
...
![Rebase - Git Rebase vs Merge - Edureka](img/6dcca38b2dc05db3e20cef71f856ffe5.png) 现在他终于可以合并主图上的特征 1 分支，结果得到下图。
