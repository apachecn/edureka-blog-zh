...
**2。[**react js**](https://reactjs.org/)是另一个主要由脸书维护的顶级 JavaScript 框架，它在脸书和 Instagram 的用户界面后面，炫耀它在维护这种高流量应用方面的效率。T11】**
...
![What is JavaScript - if flowchart](../Images/3c3225f084b50a1edf45529e07c68f51.png)T2】
