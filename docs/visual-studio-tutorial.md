...
> 原文：<https://www.edureka.co/blog/visual-studio-tutorial/>
...
![Visual-Studio-Tutorial-what-is-Visual-Studio-Edureka](img/f70f79d2d2c8f3a64f4c6f0400c71be8.png)
...
![Visual-Studio-Tutorial-Features-of-Visual-Studio-Edureka](img/e65f3362faee153d2c3e479ff17bfec2.png)
...
![Visual-Studio-Tutorial-why-choose-Visual-Studio-Edureka](img/fd22d7f4f6b0f5463b77e3ea9ddbfb7d.png)

Visual Studio 变得如此流行的主要原因是它拥有任何程序员期望从任何代码编辑器中得到的一切，以及一些额外的和有用的功能。它的轻量级、快速、开源和跨平台的特性以及其他很酷的特性使它比任何其他编辑器都有额外的优势

## **安装 Visual Studio**

![Visual-Studio-Tutorial-install-windows-Visual-Studio-Edureka](img/9a95f93a95df912b5cb6d660ec191341.png)
...
**![](img/9506f6ec24bd16b1586c5fb3d67c8563.png)**
...
![C# Tutorial Edureka Install 3](img/17f741c6b13a183948bbcc318fe2f946.png) ![C# Tutorial Edureka Install 4](img/2c4cba9092af31bbd30060bffeb5d29d.png)
...
![Visual-Studio-Tutorial-basic-Operations-Visual-Studio-Edureka](img/dd673e818d7a28f4ed020c1b07905389.png)

Microsoft Visual Studio 中的基本操作如下。

**如何打开现有项目**

![](img/f61b14d18ad3ed1a9455a0603ece3523.png)

在左上角，我们有一个**打开文件**图标。点击 in 并选择您的项目所在的目的地，如下所示。

![](img/faaf1c695df410964cfc566eb00e779f.png)

选择项目，您的代码将显示在编辑器中，如下所示。

![](img/a60e0dee651b688438a52d226076915a.png)
...
![](img/0f974d052f796eefd7efce905601dff1.png)

选择保存图标，然后运行您的代码。运行选项将位于工具栏上，如下所示。

![](img/a48392de6aabf7630824b84d9c9313f1.png)

当您运行程序时，您甚至可以在代码中设置断点，甚至可以通过右键单击文本编辑器来应用代码重新格式化。

![](img/665a25e9bb4c9160fd0d914a78c3ff58.png)

此外，让我们继续学习命令行面板。

## **命令行面板**

![Visual-Studio-Tutorial-Command-Line-Palette-Visual-Studio-Edureka](img/fb6448889884c2afed965fb2cf42b8dc.png)

Microsoft Visual Studio 代码同样可以通过键盘访问。需要掌握的最重要的组合键是 **Ctrl+Shift+P** ，它可以调出命令面板。从这里，您可以访问 VS 代码的所有或任何功能，以及最重要的常见操作的键盘快捷键。

![](img/8c0e4d37852239ba370c63f2d50e6aa3.png)

命令选项板用户界面提供了对几个命令的访问。你将执行编辑命令，打开文件，寻找符号，查看文件的快速定义，所有这些都利用了一个等效的交互窗口。下面提到几个小技巧。

![](img/d4541996fd0ddc9e66555dd652cfe4fb.png)

现在，让我们了解一下 Visual Studio 中的文件编码。

## **文件编码支持**

![](img/e24c7a8ae9c8ce0676c51eafa4819057.png)

我们可以通过使用**用户设置**或**工作区设置中的 **files.encoding** 设置来全局或基于您的工作区设置文件编码。**

![](img/c4fce52032cabbc2631dd8e32b833bda.png)

您可以在状态栏中查看文件编码。

![](img/d32118251f9c3096cd47b60c5a20f61c.png)

单击状态栏中的编码，以不同的编码重新打开或保存活动文件。

![](img/d74b3b8c948860c0f6e3e62ee23904cd.png)

然后选择一种编码。

![](img/954c896632f93b9f37a1d288c14534bb.png)

让我们了解更多的命令行参数。

## **附加命令行参数**

![Visual-Studio-Tutorial-additional-command-line-arguments-Visual-Studio-Edureka.png](img/a705cc96a7fa45356339f754f10eab21.png)
...
| **-r** | 强制打开上一个活动窗口中的文件或文件夹。**** |
| **文件** | 要打开的文件的名称。如果文件不存在，它将被创建为脏文件。您可以指定多个文件。**** |
| **文件:行:列？** | 要在指定行和可选列位置打开的文件的名称。您可以用这种方式指定多个文件，但是在使用 file:line:column？说明符**** |
...
![](img/fdb38f3c3331f72fe3ac3bcbfab1b92f.png)
...
![](img/b10c9199024601d4a64c226b627995c0.png)
