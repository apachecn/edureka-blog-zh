...
> 原文：<https://www.edureka.co/blog/selenium-vs-rpa/>
...
## **如何编写&在 Selenium 中运行一个测试用例？|爱德华卡**
...
## **Selenium vs RPA:RPA 是什么，有什么特点？**

![RPA- selenium vs RPA - Edureka](img/ee9e47234ce9fcef0238c4e99bead16e.png)机器人流程自动化(RPA)是一种商业自动化技术，有助于在没有人工干预的情况下自动化单调重复的任务(数据输入、银行业务)。
...
**![Workflow Automation - Selenium vs RPA - Edureka](img/35086fecf6401aa1bfeaaf6f1ec10b74.png)工作流自动化**是指基于一组程序规则执行任务的业务流程的自动化和执行。 这有助于设计低代码工作流，以更少的努力执行它们，管理一切并优化工作流以获得更好的结果。

**![Artificial Intelligence - Selenium vs RPA - Edureka](img/aca0abf0c796320c4e96d24fed2b902e.png) [人工智能](https://www.edureka.co/blog/what-is-artificial-intelligence)** 是完全不同的概念。它主要研究机器对人类智能的模拟。它让你的系统完成所有分配给用户的任务。   **AI** 具有行业变革能力，在业务发展上有帮助。 *** [机器学习](https://www.edureka.co/blog/what-is-machine-learning/) *** 和 *** [深度学习](https://www.edureka.co/blog/what-is-deep-learning) *** 是实现 AI 的几种方式。
...
![RPA Features - Selenium vs RPA - Edureka](img/5419e0497a55f58eab13ac14436d139e.png)
...
*本教程将向您介绍 RPA，谈论领先的 RPA 工具，如 UiPath、BluePrism 和 Automation Anywhere。*
...
![RPA Lifecycle - Selenium vs RPA - Edureka](img/2d3c8064447373e7b1388f7a7dbd8b30.png)
...
### **![Selenium Lifecycle - Selenium vs RPA - Edureka](img/8a8fd2b3bb992901f28dcb260479bc1c.png)**
...
### **![Coding - Selenium vs RPA - Edureka](img/c9edf18897a0a5857e8c73f3995aa4e8.png)编码知识是必需的吗？** 
