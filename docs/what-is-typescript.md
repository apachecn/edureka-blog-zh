...
> 原文：<https://www.edureka.co/blog/what-is-typescript/>
...
![typescript logo - what is typescript - edureka](img/37e77a56fdda891a9955aa0eefdb3aab.png)用  **将一个打字稿代码写入一个文件中。ts 扩展**  然后用编译器编译成 JavaScript。您可以在任何代码编辑器中编写该文件，并且编译器需要安装在您的平台上。安装完成后，命令  ** tsc <文件名>。ts **  将类型脚本代码编译成普通的 JavaScript 文件。
...
**![features - what is typescript- edureka](img/8328700ea02b7b5cbb4a72dbea449a73.png)**
...
**![](img/dcf5d02eda717cfae00778784b596d15.png)**
...
![install - what is typescript - edureka](img/d497cd7790fe6a700c4c47ae00949d33.png)
...
| **打字稿** | **JavaScript** |
|  ![typescript logo - what is typescript- edureka](img/c77a6d4942fdb3c1c7d602874cbf78c4.png)
...
*   它支持可选的参数功能
 ...
 |  ![](img/b3623828a6559eaf8192f167b72adec4.png)
...
*有问题吗？请在“什么是 TypeScript？”我们会回复你的。*