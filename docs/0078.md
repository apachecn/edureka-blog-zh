...
![salesforce marketing cloud - what is salesforce - edureka](img/e0987814266fc4aca6b908e795e14efa.png)  ** Salesforce 营销云**–营销云为您提供世界上最强大的数字营销平台之一。您组织中的营销人员可以使用它来管理客户旅程、电子邮件、手机、社交媒体、web 个性化、内容创建、内容管理和数据分析。
