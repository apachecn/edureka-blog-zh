...
> 原文：<https://www.edureka.co/blog/splunk-architecture/>
...
![splunk deployment pipeline-splunk architecture](img/971a91b04c4de7315cb1133bdc2a7b67.png)
...
此阶段控制用户如何访问、查看和使用索引数据。作为搜索功能的一部分，Splunk 软件存储用户创建的知识对象，如报告、事件类型、仪表板、警报和字段提取。搜索功能还管理搜索过程。

## **Splunk 组件**

如果您看下图，您会理解各种 Splunk 组件所属的不同数据管道阶段。

![splunk components-splunk architecture](img/2ca15ca9581aa43e0f5ee92ac2b9a0b8.png)
...
![splunk universal forwarder-splunk architecture](img/45a6d8914fe8f8f25bbf9fac36da5b0f.png)
...
![splunk heavy forwarder-splunk architecture](img/9e71fc7a17b244640d33c5eb5e46f4ec.png)
...
![heavy forwarder functionality-splunk architecture](img/81b97c555afc547e921aa56e3f7b14a4.png)

## **Splunk 索引器**

![splunk indexer-splunk architecture](img/e8b9b9eefa159fc40cb34c6f9e9f172b.png)
...
![splunk search head-splunk architecture](img/2ab2e93f8f3e332543682e06ff9a2290.png)
...
![splunk advanced architecture-splunk architecture](img/779f510755fa1095518ae875c8ca9cbc.png)
...
![splunk complete architecture - splunk architecture - edureka](img/28def02889cea5c775f24f076c905293.png)
...
*   当接收到该数据时，它被存储在**索引器**中。然后索引器被分解成不同的逻辑数据存储，在每个数据存储中，您可以设置权限，控制每个用户**查看、访问和使用**的内容
