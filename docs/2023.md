...
> 原文：<https://www.edureka.co/blog/database-testing/>
...
3.  **数据完整性** 测试数据库的数据完整性是指评估用于访问、管理和更新数据库的各种进程、操作和方法的过程，也称为 *CRUD* 操作。这仅仅关注于测试存储在数据库中的数据的准确性和一致性，以便我们得到预期的或想要的结果。****
