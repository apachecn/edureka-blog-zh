...
> 原文：<https://www.edureka.co/blog/interview-questions/excel-interview-questions>
...
![Worksheet-Excel Interview Questions-Edureka](img/a08e36bc2944d04e83463672f88ecf1b.png)
...
![Add cells down in excel](img/48b5f88c78ec8d6f7cfba0f57b7d8fd4.png)
...
![ribbon customization-Excel int Ques-Edureka](img/29ffa7643f9bdb63c38f33d3e60f2d8a.png)
...
![Relative cell addresses Excel-Edureka](img/96d655535eeeaf94a64c0fc75d6cb336.png)
...
![Absolute address-Excel Interview Questions -Edureka](img/300d8042213b631944f16e613a6e103b.png)
...
![Mixeed cell address-Excel Interview Questions -Edureka](img/66f5147aa018bc7b09820c1487e1322a.png)
...
![PivotTable-Edureka](img/9c2faf530fa7b92a84cb9e39f6ba7389.png)

要创建数据透视表，请选择该表并单击插入选项卡。然后选择透视表命令，您将看到以下窗口:

![Create PT-Excel Interview Questions-Edureka](img/7eca9a4eecaee092d63d65698ec70257.png)

指定要创建表格的位置，然后单击 OK。完成后，您将看到一个空的数据透视表已经创建。此外,“数据透视表字段”窗格将打开，帮助您配置数据透视表。请看下图，我在这里创建了一个数据透视表:

![adding fields-Edureka](img/849bb5fb0fc00dff6ba9b056ac95860c.png)

### **Q23)MS Excel 中的数据透视表有哪些？**

MS Excel 图表是数据可视化工具，可以帮助您以各种方式可视化数据。这些图表可以是任何类型，如条形图、饼图、面积图、折线图、圆环图等。例如，看看下图中的数据透视表:

![Pivot table-Excel Interview Questions-Edureka](img/ec4a3f141d27211cf548165ed02ae66e.png)

现在，如果您希望为该表创建一个数据透视表，请从该表中选择任意单元格，然后从“插入”选项卡中选择“数据透视表”选项。您将看到以下选项:

**![charts-Excel Interview Questions-Edureka](img/d998049d97a19256fd25349ea6a2fd71.png)**
...
1.  按 Alt+D，然后按 P 打开数据透视表向导![PivotTable wizard-Edureka](img/11f236e593e5cde09a4893a82d379b2c.png)
2.  然后选择多个合并范围选项，点击下一步，您将看到如下所示的另一个对话框:![Pivot chart wizard2-Edureka](img/38dd494f27a0fd6388dc348fc26a7cfa.png)
3.  选择我将创建页面字段选项，然后单击下一步
4.  在下一个窗口中，您需要添加所有必需的范围，如下所示:![Adding ranges-Edurek](img/cd27e009bb6ffc0a16cdb8176865bb16.png)
5.  完成后，单击下一步
6.  指定要创建表格的区域，然后点击完成![finish multiple tables for pivot tables-Edureka](img/fe50f63e79b0abc34d8abfcc2bb55cb1.png)
7.  您将看到数据透视表是通过合并两个表创建的，如下图所示:![pt from two tables-Edureka](img/4bd1326ad5c1b4ca8731d26c47e3ef74.png)
...
### **![Brad PivotTable details-Edureka'](img/86d2d0d3db995e885038ce425e0ea08f.png)**
...
![Filter PivotTable-Edureka](img/691eefcc012dc97160d265cd0fbabaed.png)
...
![Operator precedence Excel-Edureka](img/bb49a3d4cfed479d709cdf438314a07a.png)
...
### **![SUM Excel-Edureka](img/2ee39def5ad2fa9188661ad95b06d447.png)**
...
![SUMIF-Edureka](img/6997ef22fffad01877dbccbf612d0e96.png)
...
![Counta-Edureka](img/fc2ef45171c1531cd255b03fda0c7d9f.png)
...
![Countif-excel interview-Edureka](img/0ae6aa28fc2788fb249debb3a1e6d1e3.png)
...
![Countblank-Edureka](img/3ea74a7f0c4cc49c3e40096e7329d5c2.png)
...
![COUNTIFS-Edureka](img/81e3d27562972a1d0af90fce217a3bce.png)
...
*   **range_lookup** 为逻辑值，即**真或假(**真** 将找到最接近的匹配；  **假**检查精确匹配)**
...
![hlookup-Edureka](img/d2436adad5d93f0cb6db9d423b29f9c9.png)
...
![today-edureka](img/55d2e38440685a96703934ba19fda88d.png)
...
![AND-Excel Interview Questions-Edureka](img/dd0093c5ae98dcb955ad18c415f63dee.png)
...
![quick access toolbar customization-Excel Interview Questions-Edureka](img/79c6710ae40f6ef0c8b4b3e6d9205b4b.png)
...
![wilcrads Excel-Edureka](img/fd0b40cb69b84107a6084f41ed324a84.png)

这就把我们带到了这篇关于 Excel 面试问题的文章的结尾。我希望你清楚已经与你分享的一切。 ***确保你尽可能多地练习，恢复你的经验。***

*有问题吗？请在这个“Excel 面试问题”博客的评论部分提到它，我们会尽快回复您。*
