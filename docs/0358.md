...
![Case Management Salesforce Service Cloud - Edureka](../Images/b7feb207ccbbcd91741aabfb942e0930.png)  **案例管理**——客户提出的任何问题通常会被捕获并作为案例进行跟踪。病例可以进一步分为以下几种:
...
“我们的代理喜欢 Salesforce CRM 服务。他们告诉我们，在推动更好的客户体验方面，它是多么容易使用，多么非凡。”——**宪章**
