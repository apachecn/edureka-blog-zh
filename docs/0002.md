...
> 原文：<https://www.edureka.co/blog/interview-questions/top-devops-interview-questions/>
...
![devops tools - devops interview questions](img/2d55735daea3d79d5e4a42d95f9bb6a3.png)
...
### **Q9。用一个 DevOps 可以用在行业/现实生活中的用例来解释。**
...
### **Q10。解释你对过去工作过的组织的软件开发方面和技术操作方面的理解和专业知识。**
...
![](img/c9390a9305f0c7c6cf0d722326ffe437.png)
...
### **Q13。请解释一下你对过去工作过的组织的软件开发和技术操作方面的理解和专业知识。**

*   **部署频率:**这衡量一个新特性部署的频率。
*   **变更失败率:**用于衡量部署失败的次数。
*   **平均恢复时间(MTTR):** 从失败的部署中恢复所需的时间。

### **Q14。用于衡量开发运维团队成功的 KPI 是什么？**
...
## **DevOps 面试|如何破解一个 DevOps 工程师面试| DevOps 培训| edu reka**
...
![git architecture - devops interview questions](img/f4bd5f231ebdaa77b89192ed61296b41.png)

### **Q6。解释一些基本的 Git 命令？**

下面是一些基本的 Git 命令:

![git commands - devops interview questions](img/973079cd3e4e90d937005a25a70625c9.png)
...
![](img/88c691f5dbdd167ac1af800ed0f7133f.png)

### **Q16。Git Merge 和 Git Rebase 有什么区别？**
...
### **Q17。解释一下 git fetch 和 git pull 的区别？**
...
### **Q18。能否解释一下 DevOps 中“左移减少失败”的概念？**
...
![Jenkins standalone architecture - devops interview questions](img/0520142f9d324c2540414745a8896eed.png)
...
![](img/74238be27e9f9e97b173372cb4adccb4.png)
...
![automate testing - devops interview questions](img/dd0eff7f0f0a2dbbb1c3bbea01513da3.png)
...
![asset management configuration management - devops interview questions](img/959b29b05cf50c020ea4a1327d82412f.png)
...
![what is puppet - devops interview questions](img/d5e90870cf200e1d51d5ba6e4340aaca.png)
...
![chef architecture - devops interview questions](img/55731d1c2710960340ac3fb5ad68225b.png)
...
### **Q22。我能否刷新已部署应用程序的静态组件，而无需重新部署整个应用程序？**
...
### **Q24。什么时候应该使用 external_stage 选项？**
...
![nrpe architecture - devops interview questions](img/00e10f9a9f06becf82f3df093b00cd63.png)
...
![containers - devops interview questions](img/728ff02e944d9462c1991a600a277aad.png)
...
![docker vsphere - devops interview questions](img/0a932f15850f6765becee781fd22c56f.png)

### **Q4。什么是 Docker 图像？**

我建议你用下面提到的流程: Docker 图片是 Docker 容器的来源。换句话说，Docker 图像用于创建容器。图像是用 build 命令创建的，当用 run 启动时，它们将产生一个容器。图像存储在 Docker 注册表中，如 registry.hub.docker.com，因为它们可能会变得非常大，图像被设计为由其他图像的层组成，允许在网络上传输图像时发送最少量的数据。 **提示:注意 Dockerhub，以便回答预先提供的图片上的问题。**
...
[关于 DevOps](https://www.edureka.co/blog/all-you-need-to-know-about-devops "All you need to know about DevOps") 你需要知道的一切 
