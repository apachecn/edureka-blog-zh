...
> 原文：<https://www.edureka.co/blog/interview-questions/sas-interview-questions/>
...
| ***易学*** | SAS 简单易学，为已经了解 SQL 的人提供了一个简单的选项(PROC SQL)。 |
| ***数据处理能力*** | 在处理大量数据和并行计算选项方面，SAS 与包括 R & Python 在内的所有领先工具不相上下。 |
| ***图形化能力*** | SAS 提供了功能图形功能，只需稍加学习，就可以在这些图形上进行定制。 |
| ***进阶工具*** | SAS 在受控的环境中发布更新，因此它们经过了良好的测试。另一方面，Python 有一个开放的贡献，在最新的开发中有出错的可能。 |
...
![SAS - SAS Interview Questions - Edureka](img/b96751cc1108e7ab831a459b9d222acf.png)
...
![Features Of SAS - SAS Interview Questions - Edureka](img/274ecfdbe5bd3d3f89dc53effa4d0809.png)  **图:** * SAS 面试问题——SAS 的特点*
...
![SAS Framework - SAS Interview Questions - Edureka](img/a6a96dbb9b834eea95f0d4db94133565.png) **图:** * SAS 面试问题——SAS 框架* 
...
**答案:**Stop 语句使 SAS 立即停止处理当前数据步，并在当前数据步结束后恢复处理语句。
...
`proc sort ;``by month ;``run ;``proc means ;``by month ;``var avgtemp ;`
...
Proc SQL； 创建 SAS-Dataset 作为 select * from Old-SAS-Dataset 其中 var = distinct(var)； 退出；
...
#### **Weeks = intck ('week '，' 31 dec 2000'd，' 01 Jan 2001 ' d)；Years = intck('年'，' 2000 年 12 月 31 日' d，' 2001 年 1 月 1 日' d)；Months = int CK(' month '，' 31 dec 2000'd，' 01 Jan 2001 ' d)；**
...
*   除此之外，与其他语言相比，SAS 中的日期以一种特殊的方式表示。![SAS Dates - SAS Interview Questions - Edureka](img/c2915d10e4992068b5bccb87f07505d1.png)
...
![Merging Data Sets - SAS Interview Questions - Edureka](img/119acbd2157c720dad25270cbc439d38.png)
