...
> 原文：<https://www.edureka.co/blog/what-is-manual-testing/>
...
*   [什么是手工测试？](#ManualTesting)
*   [手工测试的优势](#ManualTestingPros)
*   [手工测试和自动化测试的区别](#ManualvsAutomation)
*   [什么时候使用手工测试？](#TestingScenarios)
*   [如何进行手工测试？](#ManualTestingProcess)
*   [手动测试的类型？](#ManualTestingTypes)

## **什么是手工测试？**

*手动测试是手动测试应用程序以发现缺陷和 bug 的实践。测试用例由人类手动执行，没有任何工具或脚本的支持。*

![Manual Testing - What is Manual Testing - Edureka](img/8c3a6dc68e6725b1c3c570490c64dd10.png)
...
当你开始测试时，你必须做出的一个主要决定就是你是要手动测试还是使用自动化测试。所以，你应该意识到手工测试和自动化测试有什么不同。我们结账吧。
...
![TestingProcess - What is Manual Testing? - Edureka](img/ddab10e520ae18cb29acd37068305870.png)
...
![ManualTestingTypes - What is Manual Testing - Edureka](img/325db4fb747e39790b54875d8e1889ec.png)
...
*有问题吗？请在“什么是手工测试”的评论部分提到它。“文章我们会给你回复的。*