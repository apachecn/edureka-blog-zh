...
> 原文：<https://www.edureka.co/blog/aws-vs-azure/>
...
![Pricing - AWS vs Azure - Edureka](img/99bd89e18a7a438547a3d538435c1688.png)
...
![Compute Services - AWS vs Azure - Edureka](img/5de8d700923941c61fba0c23a361b06d.png)
...
![Storage Services - AWS vs Azure - Edureka](img/9067c4afbf1e258076f65dfb723d23f7.png) AWS S3 确保跨区域的高可用性和自动复制。对于 AWS 中的临时存储，每当实例启动和停止时，它就开始工作。在终止时，它提供类似于硬盘的块存储，可以附加到任何 EC2 实例或保持独立。
...
![Database Services - AWS vs Azure - Edureka](img/0679d03a6dc9ec8448d3aa09eb570c37.png)
