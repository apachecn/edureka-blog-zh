...
> 原文：<https://www.edureka.co/blog/interview-questions/spring-interview-questions/>
...
![spring vs other frameworks - Spring Interview Questions - Edureka!](img/627584188d5a82422fb45701f29f39da.png)
...
| **版本** | **标志** | **特色** |
| **春天 2.5** | ![spring 2.5 logo - Spring Interview Questions - Edureka!](img/dae697cc97ceaeee38f87fb9964c21e9.png) | 该版本发布于 2007 年。这是第一个支持注释的版本。 |
| **春天 3.0** | ![spring 3.0 logo - Spring Interview Questions - Edureka!](img/bf0085240ffa69e6fb2b206cdac568c4.png) | 该版本发布于 2009 年。 It 充分利用了 Java5 中的改进，也为 JEE6 提供了支持。 |
| **春天 4.0** | ![Spring 4.0 logo - Spring Interview Questions - Edureka!](img/09ce1087d12a360ff00258b082a493fd.png) | 这个版本是 2013 年发布的。这是第一个完全支持 Java 8 的版本。 |

### **2。** **什么是****Spring 框架？**

*   ![Spring logo - Spring Interview Questions - Edureka!](img/63a11c5d266eccec08f24c73a26604ff.png) Spring 是一个强大的开源应用框架，旨在降低企业应用开发的复杂性。
*   它是轻量级的，松散耦合的。
...
大约有 20 个模块，概括为核心容器、数据访问/集成、Web、AOP(面向方面的编程)、工具和测试。![Spring Framework Architecture - Spring Interview Questions - Edureka!](img/fa316363faf8360c112a842721002a64.png)
...
*   **插装—**这一层 提供了对类插装和类加载器实现的支持。
*   **Test—**This 层提供了对 JUnit 和 TestNG 进行测试的支持。

下面给出几个杂项模块:

*   **消息传递-**这个 模块提供了对 STOMP 的支持。它还支持用于路由和处理来自 WebSocket 客户端的 STOMP 消息的注释编程模型。
*   **方面—**该模块提供与 AspectJ 的集成支持。

### **6。什么是 Spring 配置文件？【T2![xml file - Spring Interview Questions - Edureka!](img/91843eff59fcff1c8dd59f18db5ec08f.png)**
...
### **8。Spring 框架的各种使用方法有哪些？![spring app - Spring Interview Questions - Edureka!](img/0c8e7a4f9131fbdfac1dc9432b5f9076.png)**

Spring 框架可以以多种方式使用。它们列出如下:

1.  作为一个成熟的 Spring web 应用。
2.  作为第三方 web 框架，使用 Spring 框架中间层。
3.  用于远程使用。【T2
4.  作为企业 Java Bean，可以包装现有的 POJOs(普通旧 Java 对象)。
...
## **![ioc - Spring Interview Questions - Edureka!](img/b70c6ac1ef96d2c8f935fd8430790655.png)**
...
| **豆制品厂** | **应用上下文** |
| 是 org . spring framework . beans . factory 中定义的接口**bean factory** | org . spring framework . context 中定义的接口**application context** |
...
*   bean 是用用户提供给容器的配置元数据创建的。![Bean generation - Spring Interview Questions - Edureka!](img/e5c4096ce93f97b9d053b59f015122d3.png)

### **17。配置元数据是如何提供给 Spring 容器的？**
...
![beanLifeCycle - Spring Interview Questions - Edureka!](img/6640b297c6a91187b2bccb657b9d82d2.png)
...
![bean wiring - Spring Framework Interview Questions - Edureka!](img/512657a2bf1226ba56358b54e349f1c3.png)
...
![DAO classes - dao - Spring Framework Interview Questions - Edureka! ](img/b03c67ae99ec5c4a18efdacde0d3649a.png)
...
![orms - Spring Framework Interview Questions - Edureka!](img/2ca7fbe06bd8227805d9e210ffc52f4d.png) 下一节春季面试试题讨论关于*春季 AOP 面试试题*。
...
![AOP - Spring Framework Interview Questions - Edureka!](img/51b3987aaff7657d1a3767467fdb73e1.png)
...
程序执行过程中的一个点叫做连接点，比如一个方法的执行或者一个异常的处理。 在 Spring AOP 中，一个 连接点 总是代表一个方法的执行。 ![](img/6efa5b5fbaa7d4209ffcfef3fc963fe2.png)

### **40。什么是建议？**

某个方面在某个特定的 连接点 采取的动作被称为建议。Spring AOP 使用通知作为拦截器，在连接点“周围”维护一系列拦截器。

![advice - Spring Framework Interview Questions - Edureka!](img/13a291804b30f1b8dd9cc7e42107ebfb.png)
...
![cross cutting concern vs concern - Spring Framework Interview Questions - Edureka!](img/506394828e4ccb257cfc5692ae0f1a0d.png)

### **43。有哪些不同的 AOP 实现？**

下图描述了不同的 AOP 实现:

![AOP Implementations - Spring Framework Interview Questions - Edureka!](img/c690b48f135b9801625c5079b6858396.png)
...
![proxy - Spring Framework Interview Questions - Edureka!](img/269bb3bb29e094fdb9143d9e7cd1ee03.png)

### **46。春天，什么是编织？**

将一个方面与其他应用程序类型或对象链接起来以创建一个建议对象的过程称为编织。在 Spring AOP 中，编织是在运行时执行的。参考下图:

![Weaving - Spring Framework Interview Question - Edureka!](img/95cc050d3b8ef0d50d312be89961343f.png) 春季面试最后一段题在*春季 MVC 面试题*上。 

## **【MVC(模型-视图-控制器)****——春季面试试题**

### **47。Spring MVC 框架是什么意思？**

Spring web MVC 框架提供了模型-视图-控制器架构，并准备好使用组件来开发灵活且松散耦合的 web 应用程序。MVC 模式有助于分离应用程序的不同方面，如输入逻辑、业务逻辑和 UI 逻辑，同时提供所有这些元素之间的松散耦合。[Spring MVC](https://spring.io/guides/gs/serving-web-content/)入门 

### **48。描述 DispatcherServlet。**
...
![dispatcherServlet - Spring Framework Interview Questions - Edureka!](img/0cfae2306028e85d8d4f991e648e2db2.png)
...
![controller - Spring Framework Interview Questions - Edureka!](img/61701fe388e40c0e9b54c885a6a86def.png)
